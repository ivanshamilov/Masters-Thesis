...
n_attention_blocks = 3 # -> number of consecutive Self-Attention blocks
...
class Generator(nn.Module):
  def __init__(self):
    ...
    self.sa_blocks = nn.Sequential(*[AttentionBlock(fc_inner_dim=2*embedding_dim) for _ in range(n_attention_blocks)])
